...
if(isset($_GET['delete_user'])){
  ...
  $task_sql = "DELETE FROM task_info WHERE t_user_id = :id";
  $sent_po = "admin-manage-user.php";
  $obj_admin->delete_data_by_this_method($task_sql,$action_id,$sent_po);
              ...
              <form role="form" action="" method="post" autocomplete="off">
                <div class="form-horizontal">
                  ...
                  <div class="form-group">
                    ...
                    <div class="">
                      <input type="text" placeholder="Enter Name" name="em_fullname" list="expense" class="form-control input-custom" id="default" required>
                    </div>
                  </div>
                   <div class="form-group">
                    <label class="control-label text-p-reset">Username</label>
                    <div class="">
                      <input type="text" placeholder="Enter username" name="em_username" class="form-control input-custom" required>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="control-label text-p-reset">Email</label>
                    <div class="">
                      <input type="email" placeholder="Enter Email" name="em_email" class="form-control input-custom" required>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <div class="col-sm-offset-3 col-sm-3">
                      <button type="submit" name="add_new_user" class="btn btn-primary btn-sm rounded-0">Add User</button>
                    </div>
                    <div class="col-sm-3">
      ...
      <div class="col-md-12">
        ...
        <div class="well well-custom">
          ...
          <?php } ?>
            <?php if($user_role == 1){ ?>
                <div class="btn-group">
                  <button class="btn btn-primary-custom btn-menu" data-toggle="modal" data-target="#myModal">Add New User</button>
                </div>
              <?php } ?>
          <ul class="nav nav-tabs nav-justified nav-tabs-custom">
            <li><a href="manage-admin.php">Manage Admin</a></li>
            <li class="active"><a href="admin-manage-user.php">Manage User</a></li>
          </ul>
          <div class="gap"></div>
